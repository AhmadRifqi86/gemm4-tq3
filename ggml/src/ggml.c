...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_DECO4_L] = {
        .type_name                = "deco4",
        .blck_size                = QK_DECO,
        .type_size                = sizeof(block_deco4_l),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_deco4_l,
        .from_float_ref           = (ggml_from_float_t) quantize_row_deco4_l_ref,
    },
    [GGML_TYPE_DECO8_L] = {
        .type_name                = "deco8",
        .blck_size                = QK_DECO,
        .type_size                = sizeof(block_deco8_l),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_deco8_l,
        .from_float_ref           = (ggml_from_float_t) quantize_row_deco8_l_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_DECO4_L:  result = quantize_deco4_l (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_DECO8_L:  result = quantize_deco8_l (src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_F16:
            {
